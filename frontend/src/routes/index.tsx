          ...
          <div className="max-w-6xl mx-auto">
            <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                A modern workspace platform that brings teams together.
                Simple, powerful, and built for collaboration.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-gray-50 rounded-2xl p-16 text-center border-2 border-dashed border-gray-300">
              ...
              <p className="text-gray-500 mb-6">
                Interactive dashboard mockup will go here
              </p>
              <div className="flex gap-3 justify-center flex-wrap">
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Browser window</span>
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Clean screenshots</span>
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Animated demo</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-8 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl p-16 text-center border-2 border-dashed border-gray-300">
              ...
              <p className="text-gray-500 mb-6">
                Showcase real-world benefits or testimonials
              </p>
              <div className="flex gap-3 justify-center flex-wrap">
                <span className="px-4 py-2 bg-gray-50 border border-gray-200 text-gray-600 rounded-lg text-sm">Icon grid</span>
                <span className="px-4 py-2 bg-gray-50 border border-gray-200 text-gray-600 rounded-lg text-sm">Large cards</span>
                <span className="px-4 py-2 bg-gray-50 border border-gray-200 text-gray-600 rounded-lg text-sm">Testimonials</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-8 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="bg-gray-50 rounded-2xl p-16 text-center border-2 border-dashed border-gray-300">
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Simple centered</span>
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Gradient background</span>
                <span className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-sm">Split layout</span>
              </div>
            </div>
          </div>
        </section>
